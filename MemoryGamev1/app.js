...
var memoryArr = ['A','A','B','B','C','C','D','D','E','E','F','F','O','O','Y','Y','I','I','X','X','K','K','L','L'];
var memoryVal = [];
var memoryTileIDs = [];
var tilesFlipped = 0;
		...
		if(memoryVal.length == 0){
			...
			if(memoryVal[0] == memoryVal[1]){
				...
				function flip2Back(){
				    ...
				    tile_1.style.background = 'url(https://image.flaticon.com/icons/png/64/188/188924.png)';
            	    tile_1.innerHTML = "";
				    tile_2.style.background = 'url(https://image.flaticon.com/icons/png/64/188/188924.png)';
            	    tile_2.innerHTML = "";
				    // Clear both arrays
				    memoryVal = [];
            	    memoryTileIDs = [];
